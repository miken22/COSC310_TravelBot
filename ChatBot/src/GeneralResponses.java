...
public class GeneralResponses {
	...
	public static List<String> StartUp = Arrays.asList("Hi! Welcome to our travel center. We help arrange trips to Mexico and BC Ski Resorts. How can I help you today?");
